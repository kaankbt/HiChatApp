...
public class UserController {
    ...
    @Autowired
    public UserController(UserServiceInterface userServiceInterface, ActivityLogModelRepo activityLogEntityRepo) {
    ...
    public ResponseEntity<Void> register(@PathVariable String userName) {
        ...
        model.setActivity(ActivityType.LOGIN);
        activityLogEntityRepo.save(model);
